...
//        [_thumbLayer setContents:HexRGB(0xfffff9)];
    }
    return _thumbLayer;
}
...
- (CALayer *)progressLayer
{
    if (nil == _progressLayer) {
        ...
        _progressLayer.backgroundColor = HexRGB(0x6ab640).CGColor;
//        _slider.progressColor = HexRGB(0xfffff9);
//        _slider.progressCacheColor = ;
//        _slider.thumbColor = ;
    }
...
- (CALayer *)progressCacheLayer
{
    if (nil == _progressCacheLayer) {
        ...
        _progressCacheLayer.backgroundColor = HexRGB(0xfffff9).CGColor;
    }
